  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://bangunind.id/og-image.jpg' },
        ...
        { name: 'twitter:image', content: 'https://bangunind.id/og-image.jpg' },
      ],
      link: [
      ...
      script: [
        {
          ...
          children: JSON.stringify({
            ...
            "image": "https://bangunind.id/og-image.jpg",
